'''
@author: Gianna Fazio
SSW 810B HW 10: Stevens Data Repository 
11/10/2019
'''
...
class Student:
    ...
    #def pt_row(self):
        #completed_courses, remaining_courses, remaining_electives = self._major.grade_check(self._course)
        #return [self._cwid, self._name, self._major, completed_courses, remaining_courses, remaining_electives]
...
def main():
    ''' run the whole thing '''
    repo = Repository(r"C:\Users\Test\Desktop\Scripts\Repository10") # EDIT path to repository 
